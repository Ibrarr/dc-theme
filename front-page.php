        ...
        <div class="row">
            ...
            <div class="col-lg-6 approach">
                <div class="timeline">
                    ...
                    <div class="item">
                        <div class="content">
                            <img src="<?php echo DC_TEMPLATE_URI . '/assets/images/icons/guidance.gif'; ?>" alt="Guidance Icon">
                            <div class="text">
                                <h3>Expert Guidance</h3>
                                <p>We provide ongoing support and expert advice throughout the entire legal process.</p>
                            </div>
                        </div>
                    </div>
                    <div class="item">
                        <div class="content">
                            <img src="<?php echo DC_TEMPLATE_URI . '/assets/images/icons/feedback.gif'; ?>" alt="Feedback Icon">
                            <div class="text">
                                <h3>Continuous Feedback</h3>
                                <p>We value your input and adapt our services based on your feedback to ensure satisfaction.</p>
                            </div>
                        </div>
                    </div>
                </div>
